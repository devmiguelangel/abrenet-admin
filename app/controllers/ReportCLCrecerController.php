<?php
/**
* Reportes Clientes Crecer
*/
class ReportCLCrecerController
{
	...
	private function queryCrecer()
	{
		$this->sql = "(SELECT 
		    ...
		    (CASE sde.cobertura
		        WHEN 1 THEN sde.monto_solicitado
		        WHEN 2 THEN sdd.monto_banca_comunal
		    END) AS r_monto_solicitado,
		    (CASE sde.moneda
