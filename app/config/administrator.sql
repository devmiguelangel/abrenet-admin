...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-12-2014 a las 15:30:10
...
(1416930830, 1414006203, 1414006203),
(1416930885, 1414006201, 1414006201),
(1416930886, 1414006201, 1414006202),
(1416930887, 1414006201, 1414006205);
...
(1414006210, 1414006202, 1414006201),
(1416930829, 1414006203, 1414006202),
(1416930830, 1414006203, 1414006203),
(1416930884, 1414006201, 1414006201),
(1416930885, 1414006201, 1414006202),
(1416930886, 1414006201, 1414006203);
...
(1414006201, 'admin', '$2x$07$cQcz/XvmjL5uf4o4G1kNFuJaQjI0m6G2LsT1lsEl4di9OooBViznK', 'Administrador', 'mmamani@coboser.com', 1414006201, 1414006201, '2014-10-23', 1, 1);
...
ALTER TABLE `sa_entidad_financiera`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `codigo` (`codigo`,`dominio`);
